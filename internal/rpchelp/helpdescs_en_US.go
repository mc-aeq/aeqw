...
var helpDescsEnUS = map[string]string{
	...
	"getwalletfee--result0":  "Current tx fee (in AEQ)",
	...
	"purchaseticket-ticketfee":          "The transaction fee rate (AEQ/kB) to use (overrides fees set by the wallet config or settxfee RPC)",
