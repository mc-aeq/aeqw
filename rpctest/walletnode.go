...
// walletTestConfig contains all the args, and data required to launch a aeqw process
...
// command returns the exec.Cmd which will be used to start the aeqw
// process.
...
// to connect to the aeqw process that is launched via Start().
...
// process, and as the base for the log and data directories for aeqw.
...
// Start creates a new aeqw process, and writes its pid in a file reserved
...
// Stop interrupts the running aeqwTest process process, and waits until it exits
