...
[![GoDoc](https://godoc.org/github.com/mc-aeq/aeqw/walletdb?status.png)](http://godoc.org/github.com/mc-aeq/aeqw/walletdb)

Full `go doc` style documentation for the project can be viewed online without
installing this package by using the GoDoc site here:
http://godoc.org/github.com/mc-aeq/aeqw/walletdb

You can also view the documentation locally once the package is installed with
the `godoc` tool by running `godoc -http=":6060"` and pointing your browser to
http://localhost:6060/pkg/github.com/mc-aeq/aeqw/walletdb

## Installation

```bash
$ go get github.com/mc-aeq/aeqw/walletdb
```

## Examples

* [Basic Usage Example](http://godoc.org/github.com/mc-aeq/aeqw/walletdb#example-package--BasicUsage)  
